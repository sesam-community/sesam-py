    ...
    def __init__(self, **kwargs):
        prop_defaults = {
            ...
            "newline_before_dict_in_array": (
                False,
                "Newline before object in array",
                "Add a newline before an object within an array",
            ),
            ...
            "collapse_indent_for_dict_inside_array": (
                True,
                "Don't indent objects within arrays",
                "Avoid extra indention of objects inside arrays",
            ),
            ...
            "sort_keys_by_convention": (
                True,
                "Sort by convention",
                "Sorts object keys in conventional order instead of alphabetically",
            ),
        }
                ...
                if c == "}":
                    ...
                    if prev == "{":
                        ...
                        if (
                            ...
                            and style.collapse_indent_for_dict_inside_array
                        ):
                            output += new_line(-1)
                        else:
                            output += new_line()
        ...
        if len(stack) == 0 or stack[-1] is not STRING:
            if c == "{":
                ...
                if stack[-1] is DICT:
                    ...
                    and stack[-2] is DICT
                    and stack[-1] is ARRAY
                    and style.elements_of_array_as_value_on_separate_lines
                ):
                    output += new_line()
